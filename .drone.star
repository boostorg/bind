...
def main(ctx):
  ...
  linux_cxx("TOOLSET=clang COMPILER=clang++-6.0 CXXSTD=03, Job 22", "clang++-6.0", packages="clang-6.0", buildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'TOOLSET': 'clang', 'COMPILER': 'clang++-6.0', 'CXXSTD': '03,11,14,17,2a', 'DRONE_JOB_UUID': '12c6fc06c9'}, globalenv=globalenv),
  ...
  linux_cxx("TOOLSET=clang COMPILER=clang++-libc++ CXXSTD= Job 28", "clang++-libc++", packages="libc++-dev", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu1804:1", environment={'TOOLSET': 'clang', 'COMPILER': 'clang++-libc++', 'CXXSTD': '03,11,14,17,2a', 'DRONE_JOB_UUID': '0a57cb53ba'}, globalenv=globalenv),
  ...
  linux_cxx("CMAKE_TEST=1 Job 30", "g++", packages="", buildtype="4f03e4bebe-5d55bd2f1c", buildscript="drone", image=linuxglobalimage, environment={'CMAKE_TEST': '1', 'DRONE_JOB_UUID': '22d200f867'}, globalenv=globalenv),
  linux_cxx("CMAKE_SUBDIR_TEST=1 Job 31", "g++", packages="", buildtype="6eb948b6df-fda7c76df5", buildscript="drone", image=linuxglobalimage, environment={'CMAKE_SUBDIR_TEST': '1', 'DRONE_JOB_UUID': '632667547e'}, globalenv=globalenv),
  linux_cxx("CMAKE_INSTALL_TEST=1 Job 32", "g++", packages="", buildtype="4f03e4bebe-d62a12dd21", buildscript="drone", image=linuxglobalimage, environment={'CMAKE_INSTALL_TEST': '1', 'DRONE_JOB_UUID': 'cb4e5208b4'}, globalenv=globalenv),
    ]
